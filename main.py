...
# and fathermore locate the water ruler part above the water. 
# Mainly using cv2.HoughLinesP to find straight lines on the rule 
# and cv2.matchShapes to find possible 'E' tags on rule.
